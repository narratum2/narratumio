...
import { Building2, Palette, Landmark, Sparkles, MapPin, Waves, Castle, Sailboat } from 'lucide-react'
...
const guides = [
  {
    ...
    href: '/chiado',
    icon: <Building2 className="w-8 h-8 mx-auto" strokeWidth={1.5} />,
  },
  {
    title: 'Pr\u00edncipe Real',
    description: 'Bohemian charm in the heart of the city',
    href: '/principe-real',
    icon: <Palette className="w-8 h-8 mx-auto" strokeWidth={1.5} />,
  },
  {
    title: 'Baixa',
    description: 'Grand boulevards and timeless style',
    href: '/baixa',
    icon: <Landmark className="w-8 h-8 mx-auto" strokeWidth={1.5} />,
  },
  {
    title: 'Avenida',
    description: 'Lisbon\'s premier shopping district',
    href: '/avenida',
    icon: <Sparkles className="w-8 h-8 mx-auto" strokeWidth={1.5} />,
  },
  {
    title: 'Alfama',
    description: 'Ancient streets, authentic experiences',
    href: '/alfama',
    icon: <MapPin className="w-8 h-8 mx-auto" strokeWidth={1.5} />,
  },
  {
    title: 'Bel\u00e9m',
    description: 'Riverside beauty and historic grandeur',
    href: '/belem',
    icon: <Waves className="w-8 h-8 mx-auto" strokeWidth={1.5} />,
  },
  {
    title: 'Sintra',
    description: 'Romantic escapes in the hills',
    href: '/sintra',
    icon: <Castle className="w-8 h-8 mx-auto" strokeWidth={1.5} />,
  },
  {
    title: 'Cascais',
    description: 'Coastal elegance by the sea',
    href: '/cascais',
    icon: <Sailboat className="w-8 h-8 mx-auto" strokeWidth={1.5} />,
  },
]
