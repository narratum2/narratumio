...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://goodhandsstudio.com/services/nails' },
}
  ...
  return (
    <div className="pt-20">
      ...
      <div className="relative w-full h-[40vh] md:h-[50vh] min-h-[300px] overflow-hidden">
        <Image
          src="/brand-images/service-nail-art.jpg"
      ...
      <section className="section-padding bg-white">
        <div className="container-custom text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-serif mb-4 text-ink">Nail Care</h1>
      ...
      <section className="section-padding bg-shell">
        <div className="container-custom">
          <h2 className="text-4xl md:text-5xl font-serif mb-12 text-center">Our Nail Services</h2>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom max-w-4xl">
          <h2 className="text-4xl md:text-5xl font-serif mb-8 text-center">Lisbon Climate & Your Nails</h2>
      ...
      <section className="section-padding bg-shell">
        <div className="container-custom max-w-4xl">
          <h2 className="text-4xl md:text-5xl font-serif mb-8 text-center">Why Book Nail Services Through Good Hands?</h2>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom max-w-3xl">
          <h2 className="text-4xl md:text-5xl font-serif mb-8 text-center">Nail Services FAQ</h2>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(getBreadcrumbSchema([
          ...
          { name: 'Nail Care', url: 'https://goodhandsstudio.com/services/nails' },
        ])) }}
      />
    </div>
  )
